    ...
    <body>
        <form id="form1" runat="server">
            ...
            <style type="text/css">
                ...
                .right-inner-addon input { padding-left: 30px; }
            ...
            <div style="background-color: #B6D7A8; height: 70px; padding: 30px 10px 0 10px">
                ...
                <div style="float: right; margin: -23px 20px 0 0;">
                    <div style="color: white; font-size: 13px; font-weight: bold; margin-bottom: 3px;">Local Only</div>
            ...
            <ul style="background-color: green; padding-top: 20px;" class="clearfix">
                <li>
                    <img src='PlantImages/Aronia_arbutifolia.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Aronia Arbutifolia</div>
                </li>
                <li>
                    <img src='PlantImages/Aster_spp.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Aster Spp</div>
                </li>
                <li>
                    <img src='PlantImages/Balsamorhiza_sagittata.jpg' style="height: 150px; width: 150px;"/>
                    <div style="text-align: center">Balsamorhiza Sagittata</div>
                </li>
                <li>
                    <img src='PlantImages/Asclepias_incarnata.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Asclepias Incarnata</div>
                </li>
                <li>
                    <img src='PlantImages/Achillea_millefolium.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Achillea millefolium</div>
                </li>
                <li>
                    <img src='PlantImages/Aconitum_columbianum.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Aconitum columbianum</div>
                </li>
                <li>
                    <img src='PlantImages/Adenostoma_fasciculatum.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Adenostoma fasciculatum</div>
                </li>
                <li>
                    <img src='PlantImages/Actaea_racemosa.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Actaea racemosa</div>
                </li>
                
                <li>
                    <img src='PlantImages/Amelanchier_arborea.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Amelanchier arborea</div>
                </li>
                <li>
                    <img src='PlantImages/Amorpha_canescens.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Amorpha canescens</div>
                </li>
                <li>
                    <img src='PlantImages/Aquilegia_canadensis.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Aquilegia canadensis</div>
                </li>
                <li>
                    <img src='PlantImages/Aquilegia_coerulea.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Aquilegia coerulea</div>
                </li>
                <li>
                    <img src='PlantImages/Apocynum_cannabinum.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Apocynum cannabinum</div>
                </li>
                <li>
                    <img src='PlantImages/Anemone_spp.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Anemone spp</div>
                </li>
                <li>
                    <img src='PlantImages/Apios_americana.jpg' style="height: 150px; width: 150px;"/> 
                    <div style="text-align: center">Apios americana</div>
                </li>
                <li>
                    <img src='PlantImages/Aristolochia_californica.jpg' style="height: 150px; width: 150px;"/> 
