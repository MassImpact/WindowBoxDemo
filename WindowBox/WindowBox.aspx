    ...
    <body>
        <form id="form1" runat="server">
            ...
            <style type="text/css">
                ...
                .blue-link:hover { color: orange!important; }
            </style>
            ...
            <div style="margin: auto; width: 60%;">
                ...
                <div class="popup" style="height: 300px; width: 600px;">
                    <strong>
                ...
                <p style="margin-bottom: 100px; text-align: center;">
                    <a type="button" class="submit button btn12" style="color: white; font-size: 21px; margin: auto; min-width: 300px;" href="CreateWindowBox.aspx">Get Started</a>
                </p>
            </div>
        </form>
    </body>
