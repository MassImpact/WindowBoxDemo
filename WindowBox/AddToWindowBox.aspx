    ...
    <body>
        <form id="form1" runat="server">
            ...
            <style type="text/css">
                ...
                .pollinator-hyperlink { color: blue !important; }
                ...
                ul.circular-box li.occupied:before { background-color: gray; }
        ...
        /* Clearfix for all container boxes */
            ...
            <div style="float: left; padding: 10px; width: auto;">
                <img src='<%= Request.QueryString["plant_img"] %>' style="height: 250px; width: 250px;"/>
            </div>
            <div style="">
            ...
            <div style="clear: both; margin-top: 30px" class="clearfix">
                ...
                <a href="#" id="btnAddPlants" class="button btn36" style="float: right; font-size: 16px; font-size: 20px; font-weight: 300; line-height: 10px; margin: 0px 60px 30px 0;">Add Plants</a>
            </div>
